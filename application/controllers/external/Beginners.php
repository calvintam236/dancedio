...
class Beginners extends CI_Controller
{
	...
	function index()
	{
		...
		$this->load->view('external/beginners', $data);
		$this->load->view('external/footer');
	}
}


/* End of file Beginners.php */
/* Location: ./application/controllers/external/Beginners.php */