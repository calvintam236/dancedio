...
if ( ! isset($continue)):
?>
		<h2>Renewal: current members only</h2>
...
?>
		...
		<form method="post">
			...
			<span>If you found error in your name, please contact us to make changes.</span>
...
?>
		...
		<p>Your payment will be processed by <?php echo anchor('http://stripe.com', 'stripe'); ?>.<br><br>* indicates required.</p>
		<form method="post">
